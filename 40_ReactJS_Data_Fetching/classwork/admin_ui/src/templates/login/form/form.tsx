...
export const UserForm: FunctionComponent<UserFormProps> = ({ onSubmit }) => {
  const validate: ValidateCallback<UserFormValues, UserFormErrors> = ({
    fullName,
    email,
  }) => {
        ...
        return (
          <StyledForm noValidate onSubmit={submit}>
            <StyledField>
              ...
              />
              {errors.fullName && (
                <StyledAlert size="s">{errors.fullName}</StyledAlert>
              )}
            </StyledField>
            <StyledField>
              ...
              />
              {errors.email && (
                <StyledAlert size="s">{errors.email}</StyledAlert>
              )}
            </StyledField>
